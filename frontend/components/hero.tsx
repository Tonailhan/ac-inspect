  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center px-4 pt-24 pb-16 overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: 'url(/industrial-bg-real.jpg)',
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-zinc-950/90 via-zinc-950/85 to-zinc-900/90 pointer-events-none" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        <h1
          className="text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tight text-white mb-6 uppercase"
        ...
        >
          ...
          <p className="text-sm text-zinc-500">
            Trusted by <span className="text-zinc-300 font-medium">5,000+</span> industrial engineers worldwide
          </p>
        </motion.div> */}
      </div>
    </section>
