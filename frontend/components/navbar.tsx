    ...
    >
      ...
      >
        <a href="#" className="flex items-center gap-3">
          ...
          <span className="font-semibold text-white hidden sm:block uppercase tracking-wider">Inspector</span>
        </a>
        ...
        <div className="hidden md:flex items-center gap-3">
          <Button asChild size="sm" className="shimmer-btn bg-white text-zinc-950 hover:bg-zinc-200 rounded-full px-4">
            <a href="#analyze">Inspect Cover</a>
          </Button>
        </div>
      ...
      {mobileMenuOpen && (
        ...
        >
          <div className="flex flex-col gap-2">
            ...
            <Button asChild className="shimmer-btn bg-white text-zinc-950 hover:bg-zinc-200 rounded-full" onClick={() => setMobileMenuOpen(false)}>
              <a href="#analyze">Inspect Cover</a>
            </Button>
          </div>
        </motion.div>
